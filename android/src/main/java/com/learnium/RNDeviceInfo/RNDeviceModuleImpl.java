...
public class RNDeviceModuleImpl {
    ...
    public RNDeviceModuleImpl(ReactApplicationContext context) {
        reactContext = context;
        this.deviceTypeResolver = new DeviceTypeResolver(context);
        this.deviceIdResolver = new DeviceIdResolver(context);
        this.installReferrerClient = new RNInstallReferrerClient(context.getBaseContext());
    }
    ...
    public float getFontScaleSync() { return reactContext.getResources().getConfiguration().fontScale; }
    ...
    public double getUsedMemorySync() {
        ActivityManager actMgr = (ActivityManager) reactContext.getSystemService(Context.ACTIVITY_SERVICE);
        if (actMgr != null) {
    ...
    public boolean isAirplaneModeSync() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR1) {
            isAirplaneMode = Settings.System.getInt(reactContext.getContentResolver(),Settings.System.AIRPLANE_MODE_ON, 0) != 0;
        } else {
    ...
    public String getInstallReferrerSync() {
        SharedPreferences sharedPref = reactContext.getSharedPreferences("react-native-device-info", Context.MODE_PRIVATE);
    ...
    public String getUniqueIdSync() { return getString(reactContext.getContentResolver(), Settings.Secure.ANDROID_ID); }
